...
//         match self {
//             DataType::Ipc(v) => write!(f, "DataType::Ipc(len={})", v.len()),
//             DataType::Json(v) => write!(f, "DataType::Json({v})"),
//             DataType::Text(s) => write!(f, "DataType::Text({s})"),
//         }
//     }
// }
// 
...
//     fn default() -> Self {
//         DataType::Text("default".to_string())
//     }
// }
// 
// impl DataType {
...
//         match self {
//             DataType::Ipc(v) => size_of_val(v),
//             DataType::Json(v) => size_of_val(v),
...
//         Data::default()
//     }
//     pub fn with_df(mut self, mut df: DataFrame) -> Self {
//         let mut buffer = Vec::new();
//         let mut writer = IpcWriter::new(&mut buffer); // default options
//         writer.finish(&mut df).expect("serialize DataFrame to IPC");
//         self.data = DataType::Ipc(buffer);
//         self
//     }
//     pub fn with_string(&self, s: Vec<u8>) -> FileStore {
//         FileStore {
//             ctx: StoreContext {
...
//         }
//     }
//     pub fn with_value<T>(mut self, s: T) -> Self
//     where
//         T: Into<serde_json::Value>,
//     {
//         self.data = DataType::Json(s.into());
//         self
//     }
//     pub fn with_schema(mut self, schema: impl AsRef<str>) -> Self {
//         self.schema = schema.as_ref().into();
//         self
//     }
//     pub fn with_table(mut self, table: impl AsRef<str>) -> Self {
//         self.table = table.as_ref().into();
//         self
//     }
//     pub fn with_database(mut self, database: impl AsRef<str>) -> Self {
//         self.database = database.as_ref().into();
//         self
//     }
